...
import com.fpt.poc.analytic.config.IAnalyticConfig;
 ...
 * 
 * To turn on a 2nd time series: 1. uncomment the 3 sections below 2. in
 * SecondaryTimeseriesConfig uncomment the @Component 3. in
 * src/main/resources/application-cloud.properties uncomment the props for
 * Option 1 or 2 4. in manifest.yml uncomment and fill in the properties for
 * Option 1 or 2
 * 
 * @author predix -
 */
...
//	@Autowired
//	@Qualifier("defaultAnalyticsConfig")
//	private IAnalyticConfig analyticConfig;
	...
	public void init() {
		try {
			...
			// String test = "test" + this.analyticConfig;
			// createMetrics();
		} catch (Exception e) {
		...
		// log.debug("init secondary timeseries properties=" +
		// this.secondaryTimeseriesConfig.toString());
		...
		// createMetrics();
		// } catch (Exception e) {
		// throw new RuntimeException("unable to set up timeseries Websocket
		// Pool
		// secondaryTimeseriesConfig="
	...
	public Response getWindDataTags(String authorization) {
		try {
			...
			String json = "{ \"notification\": {\n    \"title\": \"Health Care Application\",\n    \"body\": \"5 to 1\"\n  },\n  \"to\" : \"eC4G4j3qSYc:APA91bHF7kIkH5xa9ZaeWczSdCv9VIUmnXyvEacvvxdY6CqzmwrHM27bAuMh_AVoZL4itK4MqH07OOwUZo2fV82gmBwUZWxDc6_KBN7AQqMRfzbJdWvrOfCYLRYBqEKeDwvRJahoEmwm\"\n}";
			executePost("https://fcm.googleapis.com/fcm/send", json);

			// example of calling 2nd time series
			// List<Header> headers2 =
			// this.restClient2.getSecureTokenForClientId();
			// this.restClient2.addZoneToHeaders(headers2,
			// this.secondaryTimeseriesConfig.getZoneId());
	...
	private String executePost(String targetURL, String urlParameters) {
		...
		try {
			...
			connection.setRequestProperty("Authorization",
					"key=AAAAy4LRbgI:APA91bHt06wGpRXhbpwOZolYc1kKpcx3khg0tY1UREYV-ZviR9UBLvu41K5-lNXISGwQcON5tCff74CMDxKTGFC9HUxifmNlH1u_hdJjoQ3WVKD6zdneGt8scXyGZP_3yy8CLWs4EaFv");
