...
/**
 * Properties needed to make rest calls to a second Time Series instance Please
 * uncomment the @Component and add any needed properties to
 * config/application.properties or manifest.yml
 * 
 * @author 212421693
 */
// @Component("secondaryTimeseriesConfig")
public class SecondaryTimeseriesConfig extends DefaultTimeseriesConfig implements EnvironmentAware, ITimeseriesConfig {
	private static Logger log = LoggerFactory.getLogger(SecondaryTimeseriesConfig.class);

	/**
	 * @param oauthIssuerId
	 *            the oauthIssuerId to set
	 */
	@Override
	...
	public void setEnvironment(Environment env) {
		...
		String uaaName = env.getProperty(UAA2_VCAPS_NAME); // this is set on the
															// manifest of the
															// application
